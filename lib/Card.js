...
class Card extends GameObject {
  ...
  static  getCard(id,player){
    switch(CardLib[id].type){
      case CARD_TYPE_MAP.Minions:
        return new MinionCard(id,player)
      case CARD_TYPE_MAP.Spell:
        return new WeaponCard(id,player)
      case CARD_TYPE_MAP.Weapon:
        return new SpellCard(id,player)
    }
